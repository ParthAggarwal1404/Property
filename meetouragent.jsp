    ...
    <style>
        body {
            ...
            background-color: #f4f4f4;
              background: url('https://images.pexels.com/photos/681331/pexels-photo-681331.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')
        }
        ...
        .agent-image {
            ...
            background: url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRU_0ohS_tlNLAYWtK5QpWyNq2usBRJDejdsg&usqp=CAU')
        }
